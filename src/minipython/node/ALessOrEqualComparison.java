...
public final class ALessOrEqualComparison extends PComparison
{
    private PExpression _expr1_;
    private PExpression _expr2_;

    public ALessOrEqualComparison()
    {
    }
    ...
    public Object clone()
    {
        return new ALessOrEqualComparison(
    ...
    {
        ((Analysis) sw).caseALessOrEqualComparison(this);
    }
