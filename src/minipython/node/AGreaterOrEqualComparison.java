...
public final class AGreaterOrEqualComparison extends PComparison
{
    private PExpression _expr1_;
    private PExpression _expr2_;

    public AGreaterOrEqualComparison()
    {
    }
    ...
    public Object clone()
    {
        return new AGreaterOrEqualComparison(
    ...
    {
        ((Analysis) sw).caseAGreaterOrEqualComparison(this);
    }
