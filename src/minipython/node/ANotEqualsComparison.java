...
public final class ANotEqualsComparison extends PComparison
{
    private PExpression _expr1_;
    private PExpression _expr2_;

    public ANotEqualsComparison()
    {
    }
    ...
    public Object clone()
    {
        return new ANotEqualsComparison(
    ...
    {
        ((Analysis) sw).caseANotEqualsComparison(this);
    }
